...
const Explanation: React.FC = () => {
  ...
  return (
    <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-4 flex items-start space-x-3">
      ...
      <div className="w-full">
        ...
        <p className="text-center font-mono text-cyan-300 bg-gray-900/70 rounded-md p-2 mt-3 text-xs md:text-sm">
