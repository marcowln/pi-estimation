          ...
          <div className="flex flex-col space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                disabled={isAdding}
                className="flex items-center justify-center w-full px-4 py-3 bg-cyan-500 text-white font-bold rounded-lg shadow-lg hover:bg-cyan-600 focus:outline-none focus:ring-4 focus:ring-cyan-500 focus:ring-opacity-50 transition-all duration-300 disabled:bg-gray-600 disabled:cursor-not-allowed transform hover:scale-105 disabled:scale-100"
              >
              ...
              <button
                ...
                disabled={isAdding}
                className="flex items-center justify-center w-full px-4 py-3 bg-cyan-600 text-white font-bold rounded-lg shadow-lg hover:bg-cyan-700 focus:outline-none focus:ring-4 focus:ring-cyan-600 focus:ring-opacity-50 transition-all duration-300 disabled:bg-gray-600 disabled:cursor-not-allowed transform hover:scale-105 disabled:scale-100"
              >
                <PlusIcon className="w-5 h-5 mr-2" />
                Add 100 Points
              </button>
            ...
            <button
              ...
              className="w-full px-5 py-2 bg-red-600/80 text-white font-semibold rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-500 focus:ring-opacity-50 transition-all duration-300 disabled:bg-gray-500 disabled:cursor-not-allowed"
            >
              Reset Simulation
            </button>
          </div>
